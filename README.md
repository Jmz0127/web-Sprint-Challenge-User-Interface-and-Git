...
4. While using flexbox, what axis does the following property work on: `align-items: center`?
   ...
   1. It works on the perpendicular axis whereas justify-items works on the main axis.

5. Explain why git is valuable to a team of developers.

   1. Git is instrumental in that it allows branching which allows dev teams to work independently before bringing their work to the main branch. Opens up collaboration and version control.
